...
public class CloudDataThreaded {
	...
	public static void main(String [] args){
		...
		for (int i = 0;i<11;i++){
			...
			// for(int t = 0; t < dimt; t++){
				// classification = classifyThreaded(t);				// classification of all cells in timestep
			classification = classifyThreaded();
			// }
			// classifyAll();
	...
	static Integer[][][] classifyThreaded(){
		return fjPool.invoke(new SumLocal(dimx,dimy,advection,convection,classification,0,dim()));
